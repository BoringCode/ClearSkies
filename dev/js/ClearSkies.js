...
]).factory('Settings', ['$rootScope', '$filter', 'errors',
...
]).factory('GeoLocation', ['$q', '$window', '$rootScope', '$resource', '$filter', '$timeout', 'errors', 'Settings',
...
]).directive('detectDevice', ['$document',
	function($document) {
		return {
			link: function(scope, element, attrs) {
...
}).directive("noTouchScroll", function() {
	return {
		link: function(scope, element, attrs) {
...
]).controller("Settings", ['$scope', '$rootScope', '$filter', '$timeout', 'Weather', 'Settings', 'GeoLocation',
...
]).controller("Message", ['$scope', '$rootScope',
